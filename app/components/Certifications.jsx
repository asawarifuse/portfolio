    ...
    <section id="certifications" className="min-h-screen flex flex-col justify-center px-6 md:px-20 lg:px-40 py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {certifications.map((cert, i) => (
          <div key={i} className="bg-[#111111] rounded-xl p-6 border border-gray-800 hover:border-blue-500 hover:scale-[1.02] transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 flex flex-col justify-between">
            <div>
